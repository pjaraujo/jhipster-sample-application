...
describe('ShippingProcess Management Component', () => {
  let comp: ShippingProcessComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'shipping-process', component: ShippingProcessComponent }]),
      ...
      .overrideTemplate(ShippingProcessComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.shippingProcesses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
